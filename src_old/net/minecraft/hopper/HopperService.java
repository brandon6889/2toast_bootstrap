...
public final class HopperService {
   ...
   public static SubmitResponse submitReport(Proxy proxy, String report, String product, String version, Map env) throws IOException {
   ...
   private static Response makeRequest(Proxy proxy, URL url, Object input, Class classOfT) throws IOException {
